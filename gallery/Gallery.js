...
export default class Gallery extends Component {
  ...
  componentWillMount() {
    ...
    this.gestureResponder = createResponder({
      onStartShouldSetResponderCapture: (evt, gestureState) => true,  // eslint-disable-line no-unused-vars
      ...
      onResponderSingleTapConfirmed: (evt, gestureState) => { // eslint-disable-line no-unused-vars
  ...
  getCurrentImageTransformer = () => this.getImageTransformer(this.currentPage);

  getViewPagerInstance = () => this.refs.galleryViewPager;
